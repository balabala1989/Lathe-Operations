...
public class LatheBorningScreen extends MainScreen implements FieldChangeListener {
	...
	public LatheBorningScreen() {
        ...
        rtfHeading = new RichTextField("Calculate Time for Boring", RichTextField.TEXT_ALIGN_HCENTER){
	    ...
	    lengthLabel = new LabelField( "Length to be bored (m)" ){
